        ...
        <div className="about__collage">
          ...
          <div className="about__text reveal">
            ...
            <p>
              ...
              Shama Brews &amp; Base is a quiet corner of the Kumaon Himalayas where the
          ...
          <div className="about__collage-images reveal">
            <div className="about__collage-primary">
              <Image
                ...
                alt="Stone-and-mud cottage with marigolds at Shama Brews & Base"
                fill
            ...
            <div className="about__collage-secondary">
              <Image
                ...
                alt="Rustic wooden cabin interior at Shama Brews & Base"
                fill
